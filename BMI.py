...
class MyWindow:
    def __init__(self,win):
        ...
        self.label1.place(x=85,y=20)
        self.label2.place(x=18,y=82)
        self.label3.place(x= 25,y=132)
        self.label4.place(x=25,y=182)
        self.label5.place(x=25,y=232)
        self.label6.place(x=25,y=282)
        self.menu1.place(x=135,y=82)
        self.ey1.place(x=135,y=132)
        self.ey2.place(x=135,y=182)
        self.ey3.place(x=135,y=232)
        self.ey4.place(x=135, y=282)
        self.btn1.place(x=140,y=350)
